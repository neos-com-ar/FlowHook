                ...
                <div className="bg-gray-50 border border-gray-200 rounded-md p-4 mb-4">
                  <details>
                    ...
                    <ul className="text-xs text-gray-600 space-y-1 list-disc list-inside mt-1">
                      ...
                      <li>Para valor por defecto cuando el campo es null o no existe, usa <code className="bg-gray-200 px-1 rounded">::isnull(&quot;valor&quot;)</code> o <code className="bg-gray-200 px-1 rounded">::isnull(0)</code> (ej: <code className="bg-gray-200 px-1 rounded">data.nombre::isnull(&quot;N/A&quot;)</code>)</li>
