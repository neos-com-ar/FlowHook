...
if (useKV) {
  try {
    ...
    console.log('✅ Usando Vercel KV/Upstash como adapter para NextAuth');
  } catch (error) {
...
export default function Adapter() {
  const adapter = {
    async createUser(user) {
      ...
      // Si el usuario no tiene contraseña, establecer hasPassword: false
      const userData = { 
        ...user, 
        id: userId,
        hasPassword: user.hasPassword !== undefined ? user.hasPassword : false,
